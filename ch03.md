...
De organisatie die verantwoordelijk is voor het creëren van de beschreven bron. Voor de invulling van deze eigenschap wordt vereist dat een concept uit de [`waardelijst overheid:Organisatie`](#waardelijst-overheid-Organisatie) gekozen wordt.
...
Deze eigenschap bevat de analyse waarmee de toepasselijke wet- & regelgeving door de eigenaar naar de uitvoeringspraktijk is vertaald en die (uiteindelijk) in de vorm van de regelspecificatie set is geubliceerd. Voor de invulling van deze eigenschap wordt vereist dat een concept uit de [`waardelijst analysis`](#waardelijst-analysis) gekozen wordt.

| Definitie      | Waarde            |
| -------------- | ----------------- |
| RDF Eigenschap | `ronl:analysis`   |
| Bereik         | TODO: Waardelijst |
| Kardinaliteit  | `1..1`            |
| Gebruik        | Mandatory         |
